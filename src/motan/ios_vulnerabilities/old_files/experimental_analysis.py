...
binpath = Path(os.path.join("/home/dave/Research/motan/src", "working_dir_motan_ios","iGoat-Swift_binary", "iGoat-Swift_binary_arm64"))
...
baned = re.findall(
            ...
            '_fopen|_chmod|_chown|_stat|_mktemp', dat)
